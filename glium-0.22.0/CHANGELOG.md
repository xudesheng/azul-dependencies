...
## Version 0.23.0 (2018-12-03)

 - Fork from tomaka/master
 - Updated glutin to version 0.19.
 - Change name to `azul_glium` to indicate fork
 - [BREAKING] Removed HeadlessRenderer (due to incompatibility with glutin 0.19)
