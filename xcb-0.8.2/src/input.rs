...
impl DeviceKeyPressEvent {
    ...
    pub fn new(response_type: u8,
        ...
        unsafe {
            ...
            assert!(response_type == DEVICE_BUTTON_PRESS ||
...
impl ButtonPressEvent {
    ...
    pub fn new(response_type: u8,
        ...
        unsafe {
            ...
            assert!(response_type == BUTTON_RELEASE ||
                    response_type == BUTTON_PRESS ||
...
impl RawButtonPressEvent {
    ...
    pub fn new(response_type: u8,
        ...
        unsafe {
            ...
            assert!(response_type == RAW_MOTION ||
                    response_type == RAW_BUTTON_PRESS ||
...
impl TouchBeginEvent {
    ...
    pub fn new(response_type: u8,
        ...
        unsafe {
            ...
            assert!(response_type == TOUCH_UPDATE ||
                    response_type == TOUCH_END ||
                    response_type == TOUCH_BEGIN,
